...
PM_DATA_DIR = os.path.join(DATA_DIR, 'path_make')
PM_GOOD = os.path.join(PM_DATA_DIR, 'initial_points.txt')
# PB_GOOD_XYZ = os.path.join(PM_DATA_DIR, '100th_CEC_z2_4.xyz')
# PB_REF_XYZ = os.path.join(PM_DATA_DIR, 'ref-100th_CEC_z2_4.xyz')
# PB_GOOD_LOG = os.path.join(PM_DATA_DIR, '100th_CEC_z2_4.log')
# PB_REF_LOG = os.path.join(PM_DATA_DIR, 'ref-100th_CEC_z2_4.log')
PM_BAD_LEN = os.path.join(PM_DATA_DIR, 'bad_length.txt')
PM_BAD_DATA = os.path.join(PM_DATA_DIR, 'bad_data.txt')


class TestProcessInfile(unittest.TestCase):
    def testGood(self):
        xyz_idx, min_z, max_z = process_infile(PM_GOOD, "z")
    ...
    def testBadLen(self):
        xyz_list, min_z, max_z = process_infile(PM_BAD_LEN, "x")
        self.assertEqual(2, len(xyz_list))
        check_idx_lines(self, xyz_list)

    def testBadData(self):
        xyz_list, min_z, max_z = process_infile(PM_BAD_DATA, "y")
