...
DEF_FLIST_SUM_PATH = os.path.join(CP2K_DATA_DIR, 'force_sums_cp2k_force_list_good.csv')
GOOD_FLIST_SUM_PATH = os.path.join(CP2K_DATA_DIR, 'force_sums_cp2k_force_list_good_good.csv')
...
class TestConvertCP2K(unittest.TestCase):
    ...
    def testMissingIncompleteFile(self):
        ...
        with capture_stdout(convert_cp2k_forces.main,["-l", INCOMP_FLIST_PATH]) as output:
