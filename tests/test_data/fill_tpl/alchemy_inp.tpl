...
parameters          ../../toppar/par_all36_carb_alchemy.prm
...
wrapNearest         off;               # use for non-rectangular cells (wrap to the nearest image)
                                       # cellBasisVectors from xsc file, not needed explicitly
...
useConstantArea         no;            # keeps the ratio of the unit cell in the x-y plane constant A=B
...
langevinPistonPeriod 100.0;            # oscillation period in fs. correspond to pgamma T=50fs=0.05ps
                                       # f=1/T=20.0(pgamma)
langevinPistonDecay   50.0;            # oscillation decay time. smaller value correspons to larger random
