...
LAM_ATOMS = {7500000:
                 {17467: [1116, 38, -0.82, -13.3474, -9.77472, 0.566407],
                  4167: [272, 9, -0.51, -2.90332, 4.1959, -0.319479]},
             7500010:
                 {17467: [1116, 38, -0.82, -13.2865, -9.72761, 0.578118],
                  4167: [272, 9, -0.51, -2.92659, 4.13608, -0.270837]},
             7500020:
                 {17467: [1116, 38, -0.82, -13.2259, -9.67559, 0.587055],
             ...
             7500040: {
                 17467: [1116, 38, -0.82, -13.1348, -9.58866, 0.605338],
                 4167: [272, 9, -0.51, -3.05803, 4.06638, -0.176754]},
             7500050: {
                 17467: [1116, 38, -0.82, -13.1059, -9.56761, 0.624937],
                 4167: [272, 9, -0.51, -3.08408, 4.11423, -0.1371]},
             7500060: {
                 17467: [1116, 38, -0.82, -13.0893, -9.54197, 0.645511],
                 4167: [272, 9, -0.51, -3.15378, 4.16002, -0.134485]},
             7500070: {
                 17467: [1116, 38, -0.82, -13.0658, -9.51954, 0.683413],
                 4167: [272, 9, -0.51, -3.19654, 4.23121, -0.120521]},
             7500080: {
                 17467: [1116, 38, -0.82, -13.0411, -9.49329, 0.73031],
                 4167: [272, 9, -0.51, -3.20867, 4.30202, -0.0954135]},
             7500090: {
                 17467: [1116, 38, -0.82, -13.0308, -9.46276, 0.771404],
                 4167: [272, 9, -0.51, -3.27254, 4.37238, -0.111996]},
             7500100: {
                 17467: [1116, 38, -0.82, -13.028, -9.43718, 0.8038],
...
class TestMain(unittest.TestCase):
    def testDefault(self):
        try:
            md_utils.lammps_dist.main([DUMP_PATH, "-p", PAIRS_PATH])
            self.assertEqual(0, len(diff_lines(STD_DIST_PATH, DIST_PATH)))
        finally:
