...
DEF_TRAJ_FILE = '../step5_assembly.xplor_ext.psf'
DEF_NAME = 'output'
DEF_DIR = './'
...
def parse_cmdline(argv):
    ...
    parser.add_argument("-p", "--top", help="Topology file for analysis.The default is {}.".format(DEF_TRAJ_FILE),
                        default=DEF_TRAJ_FILE)
    ...
    parser.add_argument("-o", "--outdir",
                        ...
                        default=DEF_DIR)
    parser.add_argument("-a", "--args", help="Additional arguments, required by some tcl scripts.")
...
def main(argv=None):
    ...
    try:
        call_vmd(args.top, args.traj, args.script, file_path)
    except IOError as e:
