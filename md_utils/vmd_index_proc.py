#!/usr/bin/env python
"""
Given a file with lines of vmd indices:
return a file that has a column of data for each line and base-1 indices
"""
...
import sys
import itertools
from md_utils.md_common import (InvalidDataError, warning, process_cfg, get_fname_root,
...
# Defaults
DEF_CFG_FILE = 'vmd_index_proc.ini'
DEF_FILE = 'raw_indices.csv'
DEF_OUT = 'vmd_index_proc.txt'
DEF_DELIMITER = ','
DEF_PREFIX = ''
DEF_MIDDLE = ''
DEF_SUFFIX = ''
