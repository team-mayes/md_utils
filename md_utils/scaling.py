...
RUN_NAMD_BRIDGES_FULLNODE = "module load namd\nmpirun -np $SLURM_NTASKS namd2 +ppn 12 +pemap 1-6,15-20,8-13,22-27 " \
                            "+commap 0,14,7,21 {} >& {}"
RUN_NAMD_GREATLAKES = "module load intel\nmodule load impi\nmpirun -np 1 /home/xadams/NAMD_2.13_Linux-x86_64-multicore/namd2 +ppn $SLURM_NPROCS {} >& {}"
RUN_NAMD_GREATLAKES_FULLNODE = "module load intel\nmodule load impi\nmpirun -np 36 /home/xadams/NAMD_2.13_Linux-x86_64-multicore/namd2 +pemap 0-35 {} >& {}"
